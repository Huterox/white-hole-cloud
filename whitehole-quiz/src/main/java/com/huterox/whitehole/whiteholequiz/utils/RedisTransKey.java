...
public class RedisTransKey {
    ...
    public static String setUserChangePassWordKey(String key){return RedisNameSpace+':'+RedisUserChangePassWordName+":"+key; }
    public static String setUserChangePassWordEmailKey(String key){return RedisNameSpace+':'+RedisUserChangePassWordEmailName+":"+key; }
    ...
    public static String getUserInfoEditorKey(String key){return setUserInfoEditorKey(key);}
    public static String getUserUpHeadImgKey(String key){return setUserUpHeadImgKey(key);}
    public static String getUserChangePassWordKey(String key){return setUserChangePassWordKey(key);}
    public static String getUserChangePassWordEmailKey(String key){return setUserChangePassWordEmailKey(key);}
}
