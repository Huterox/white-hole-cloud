    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.myUserid) {
            this.$http({
              url: this.$http.adornUrl(`/whiteholehole/friendfriend/info/${this.dataForm.myUserid}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/whiteholehole/friendfriend/${!this.dataForm.myUserid ? 'save' : 'update'}`),
              method: 'post',
