  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="这个是密码，后面会使用md5加密">
      </el-table-column>
      <el-table-column
        prop="userid"
        header-align="center"
        align="center"
        label="这个是用户id,使用uuid生成，是全局唯一的，相当于公钥">
      </el-table-column>
      <el-table-column
        prop="nickname"
        header-align="center"
        align="center"
        label="用户昵称，可重复，默认会把username作为昵称，可修改">
      </el-table-column>
      <el-table-column
        prop="age"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="用户电话号码，用于后期密码找回">
      </el-table-column>
      <el-table-column
        prop="email"
        header-align="center"
        align="center"
        label="用户邮箱，用于用户注册验证，密码找回，如果用户在本平台注册的话，是必须要的
">
      </el-table-column>
      <el-table-column
        prop="describe"
